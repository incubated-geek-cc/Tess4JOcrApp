...
public class ContentConstants {
    ...
    private static final String DISPLAY_OCR_ALL_DIALOG_MSG =  "🔋 𝗘𝘅𝘁𝗿𝗮𝗰𝘁𝗶𝗼𝗻 𝗦𝘁𝗮𝘁𝘂𝘀: 🗹 𝖲𝖴𝖢𝖢𝖤𝖲𝖲" 
        + LINE_SEPARATOR
        + "𝖳𝖾𝗑𝗍 𝖽𝖺𝗍𝖺 𝖾𝗑𝗍𝗋𝖺𝖼𝗍𝗂𝗈𝗇 𝗁𝖺𝗌 𝖻𝖾𝖾𝗇 𝖼𝗈𝗆𝗉𝗅𝖾𝗍𝖾𝖽 𝖿𝗈? 𝖺𝗅𝗅 𝗎𝗉𝗅𝗈𝖺𝖽𝗌."
        + LINE_SEPARATOR
    ...
    public String[] getQuickTips() {
        String[] quickTips = {
            ...
            "𝖠𝗉𝗉𝗅𝗂𝖼𝖺𝗍𝗂𝗈𝗇 𝗐𝖺𝗌 𝖻𝗎𝗂𝗅𝗍 𝗐𝗂𝗍𝗁 𝖳𝖾𝗌𝗌𝟦𝖩 (𝟦.𝟧.𝟣), 𝖺 𝖩𝖺𝗏𝖺 𝗐𝗋𝖺𝗉𝗉𝖾𝗋 𝖿𝗈𝗋 𝖳𝖾𝗌𝗌𝖾𝗋𝖺𝖼𝗍—",
            ...
            "￭ 𝖮𝗇𝗅𝗒 𝟣 𝖯𝖣𝖥 𝖿𝗂𝗅𝖾 𝖼𝖺𝗇 𝖻𝖾 𝗌𝗎𝖻𝗆𝗂𝗍𝗍𝖾𝖽 𝗉𝖾𝗋 𝗎𝗉𝗅𝗈𝖺𝖽 𝖿𝗈𝗋 𝖮𝖢𝖱 𝗍𝗈 𝗉𝗋𝗈𝖼𝖾𝗌𝗌 𝗂𝗍𝗌 𝗉𝖺𝗀𝖾𝗌",
            "￭ 𝖥𝗈𝗋 𝗈𝗉𝗍𝗂𝗆𝖺𝗅 𝖮𝖢𝖱 𝗉𝖾𝗋𝖿𝗈𝗋𝗆𝖺𝗇𝖼𝖾, 𝗉𝗋𝖾𝖿𝖾𝗋𝗋𝖾𝖽 𝗂𝗆𝖺𝗀𝖾 𝗋𝖾𝗌𝗈𝗅𝗎𝗍𝗂𝗈𝗇 𝗂𝗌 𝟥𝟢𝟢𝖣𝖯𝖨",
            "",
            "𝗣𝗮𝗿𝘁 𝗜𝗜. 𝗨𝘀𝗮𝗴𝗲 𝗼𝗳 𝗳𝘂𝗻𝗰𝘁𝗶𝗼𝗻𝗮𝗹𝗶𝘁𝗶𝗲𝘀 𝗼𝗻 𝗹𝗲𝗳𝘁 𝗽𝗮𝗻𝗲𝗹",
            "￭ 𝖴𝗌𝖾 " + PREV_PAGE_BTN_TEXT + " & " + NEXT_PAGE_BTN_TEXT + " 𝗍𝗈 𝗍𝗈𝗀𝗀𝗅𝖾 𝗉𝖺𝗀𝖾 𝗌𝖾𝗅𝖾𝖼𝗍𝗂𝗈𝗇",
            "￭ 𝖴𝗌𝖾 " + ZOOM_IN_BTN_TEXT + " & " + ZOOM_OUT_BTN_TEXT + " 𝗍𝗈 𝗓𝗈𝗈𝗆 𝗂𝗇/𝗈𝗎𝗍 𝗈𝖿 𝗂𝗆𝖺𝗀𝖾",
            "￭ 𝖴𝗌𝖾 " + ROTATE_LEFT_BTN_TEXT + " & " + ROTATE_RIGHT_BTN_TEXT + " 𝗍𝗈 𝗋𝗈𝗍𝖺𝗍𝖾 𝗂𝗆𝖺𝗀𝖾 𝖺𝗇𝗍𝗂-𝖼𝗅𝗈𝖼𝗄𝗐𝗂𝗌𝖾/𝖼𝗅𝗈𝖼𝗄𝗐𝗂𝗌𝖾",
            "￭ 𝖴𝗌𝖾 " + FIT_IMAGE_BTN_TEXT + " 𝗍𝗈 𝖿𝗂𝗍 𝗂𝗆𝖺𝗀𝖾 𝗍𝗈 𝗉𝖺𝗇𝖾𝗅",
            "",
            "𝗣𝗮𝗿𝘁 𝗜𝗜𝗜. 𝗥𝘂𝗻𝗻𝗶𝗻𝗴 𝘁𝗵𝗲 𝗢𝗖𝗥 𝗽𝗿𝗼𝗴𝗿𝗮𝗺𝗺𝗲",
